    ...
    <div class="wrapper">
        ...
        <?php
        $data = array(
          'ID' => 'txtDDpsychologist',
          'Class' => 'dd col-md-4',
          'DataTextField' => 'Name',
          'DataValueField' => 'PsychologistID'
        );
        $options = [
                  '' => ''
        ]
...
echo form_label('', '', $attributes);?>
        ...
        <fieldset class="section">
          ...
          $data = array(
            ...
            'rows' => '3',
            'maxlength' => '220',
            'placeholder' => 'Write your suggestions please'
            );
        ...
        <?php 
          $data = array(
            'ID' => 'txtRating',
            'OnTextChanged' => 'txtRating_TextChanged'
            );
          ...
          ?>
            ...
            $data = array(
              'ID' => 'btnPatFeedsubmit',
              'Text' => 'Submit',
              'CssClass' => 'btn submit button',
              'OnClick' => 'btnPatFeedsubmit_Click'
      );
