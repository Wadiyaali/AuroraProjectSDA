       <div class="feed">
           <div class="sess">
               <main role="main">
                   ...
                   <?php if ($this->session->flashdata('feedbackSuccess')) : ?>
                       <p class="alert alert-success"><?php echo $this->session->flashdata('feedbackSuccess'); ?> </p>
                   <?php endif; ?>

                   <?php if ($this->session->flashdata('feedbackError')) : ?>
                       <p class="alert alert-danger"><?php echo $this->session->flashdata('feedbackError'); ?> </p>
                   <?php endif; ?>
               </main>
           </div>
       </div>