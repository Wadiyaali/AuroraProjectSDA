    ...
    <div class="article">
        ...
        <div class="add-new-article">
            ...
            <div class="form-group col-md-12 col-lg-12">
              ...
              );    echo form_label("Title","txtArticleTitleWri",$data); ?>	
                        <?php
                    $data=array(
                        'type'=>'text',
                        'class'=>'form-control col-md-9 col-lg-9 light-text',
                        'id'=>'txtArticleTitleWri',
                        'name'=>'txtArticleTitleWri',
                         );
              ...
              );    echo form_label("Content","txtArticleContentWri",$data); ?>	
                        <?php
                    $data=array(
                        'type'=>'text',
                        'class'=>'form-control col-md-9 col-lg-9 light-text',
                        'id'=>'txtArticleContentWri',
                        'name'=>'txtArticleContentWri',
                        'rows'=>8,
