<div class="main-overview">
      ...
      <div class="overviewCard">
        ...
        <div class="overviewCard-description">
          <h3 class="overviewCard-title">Upcoming <strong>Event</strong></h3>
      ...
      <div class="overviewCard">
        ...
        <div class="overviewCard-description">
          <h3 class="overviewCard-title"> <strong>Aurora Members</strong></h3>
      ...
      <div class="overviewCard">
        ...
        <div class="overviewCard-description">
          <h3 class="overviewCard-title"> <strong> Fund Raising Concert</strong></h3>
